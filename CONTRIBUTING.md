...
AURUM is an MT5 research project for HFM Gold Cent. Contributions are welcome
when they make the strategy easier to test, safer to run, or clearer to review.
This is not a live-trading release and it does not promise returns.
...
- Do not commit credentials, account identifiers, terminal logs with personal
  data, or notification tokens.
