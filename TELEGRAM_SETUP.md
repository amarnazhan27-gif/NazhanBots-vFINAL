...
events to the MetaTrader Common Files outbox. `telegram_relay.py` reads that
...
4. Run `python3 telegram_relay.py --once --dry-run` first. Then run
   `python3 telegram_relay.py` under a supervised service.
