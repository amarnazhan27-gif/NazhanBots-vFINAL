...
echo -e "\e[1;32m🔥 PROJECT SUPERIOR v43 INSTALLER 🔥\e[0m"
...
echo -e "\e[1;34m📦 [SETUP] Installing Python Libraries...\e[0m"
...
echo -e "\e[1;36m🔗 Installing Boot Persistence...\e[0m"
if command -v crontab >/dev/null; then
    (crontab -l 2>/dev/null; echo "@reboot bash $(pwd)/guardian.sh") | crontab -
    echo -e "\e[1;32m✅ Persistence Installed! Server will auto-start on boot.\e[0m"
else
    echo -e "\e[1;33m⚠️ Crontab not found. Auto-start skipped.\e[0m"
fi

echo -e "\e[1;32m✅ Setup Complete! Run 'bash guardian.sh' to start.\e[0m"
else
    echo -e "\e[1;31m❌ INSTALLATION FAILED! Check errors above.\e[0m"
fi
